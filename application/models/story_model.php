...
class Story_model extends CI_Model{
	var $dbName = 'Story';
	var $primaryKey = 'id';
	var $resource_db = 'S_Resource';
	var $resource_foreign_key = 's_resource';
	var $limit = DOWNLOAD_SLOT_SIZE;
	var $reply_foreign_key ='sr_s';
	var $reply_db ='';
	...
	*	
	***/
	public function update_story($q_id,$data=FALSE){
	...
	*/
	...
	//插入数据库
	public function set_story($data)
	{
