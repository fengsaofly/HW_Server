...
class learnEnglishReply_model extends CI_Model{
	var $dbName = 'learnEnglishReply';
	var $primaryKey = 'id';
	...
	*	
	***/
	// public function get_story($slug=FALSE,$limit)
	public function get_learnEnglishReply($start=-1,$params=FALSE)
	{
	...
	*	
	***/
	public function update_learnEnglishReply($q_id,$data=FALSE){
    ...
    // public function get_story($dataArray){
	...
	*/
	...
	public function set_learnEnglishReply($data)
	{
