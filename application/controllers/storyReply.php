...
*  
*/
class StoryReply extends CI_Controller
{
	var $ak = '7244d82a2ef54bfa015a0d7d6f85f372';
	
    
    var $base_dir = 'StoryReply';
    var $cur_picname = '';
            ...
            else
            {
                ...
                if($status==0){
                    ...
                    else
                    {
                        ...
                        if ($newIDs['sr_id'] <= 0 ) {
                            $status = 5;
                            $message = 'insert a new storyReply failed';
                        }
                    ...
                    //     // print_r($_FILES);die();
                    //     //上传资源
                    //     $resultArray = $this->upload->multiple('qr_resources',$user_id,'storyReply');
            ...
            else
            {
                ...
                if ($status == 0) {
                    ...
                    if($contentArray == null){
                        ...
                        $status = 4;
                        $message = 'no storyReplys you can get';
                    }
                    //有内容
                    else{
